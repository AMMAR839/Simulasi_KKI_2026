...
class GpsWaypointFollower(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("reach_radius_m", 0.65)
        ...
        self.declare_parameter("obstacle_slow_distance_m", 1.20)
        self.declare_parameter("lidar_self_filter_distance_m", 0.45)
        self.declare_parameter("front_scan_half_angle_deg", 14.0)
        ...
        self.declare_parameter("segment_pass_margin_m", 0.35)
        self.declare_parameter("gate_cross_track_radius_m", 0.75)
        ...
        self.declare_parameter("lidar_detection_max_distance_m", 2.50)
