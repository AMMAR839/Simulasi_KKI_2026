...
setup(
    ...
    description="Sensor bridge configuration and health monitor for ASV simulation.",
    license="MIT",
    entry_points={
        "console_scripts": [
            "sensor_status_monitor = asv_sensors.sensor_status_monitor:main",
            "collision_monitor = asv_sensors.collision_monitor:main",
        ],
    },
)
